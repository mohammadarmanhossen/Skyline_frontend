...
const userProfile = () => {
  ...
  fetch("https://skyline-backend.vercel.app/client/users/")
    ...
    .then((data) => {
      ...
      if (!currentUser) {
        parent.innerHTML = `<p class="text-red-500 text-center">User not found</p>`;
        return;
      }
          ...
          <div class="bg-white w-full max-w-4xl rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="pt-24 pb-10 px-6 md:px-10 text-center">
              ...
              <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  <p class="text-xl font-bold text-gray-600">৳50,500</p>
    ...
    .catch((error) => {
      parent.innerHTML = `<p class="text-red-500 text-center">Failed to load user profile.</p>`;
